    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deviceType', models.SmallIntegerField(choices=[(1, 'Radiography X-Ray'), (2, 'Fluoroscope X-Ray'), (3, 'Angiography X-Ray'), (4, 'Mobile X-Ray'), (5, 'CT'), (6, 'MRI'), (7, 'USG'), (8, 'PET'), (9, 'SPECT'), (10, 'PET-CT'), (11, 'PET-MR'), (12, 'SPECT-CT')], verbose_name='Device type')),
                ('manufacturer', models.SmallIntegerField(choices=[(1, 'SHIMADZU'), (2, 'HITACHI'), (3, 'SIEMENS'), (4, 'PHILIPS'), (5, 'GENERAL ELECTRIC'), (6, 'CANON'), (7, 'FUJI'), (8, 'CARESTREAM'), (9, 'OTHER')], verbose_name='Manufacturer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('jobType', models.SmallIntegerField(choices=[(1, 'Maintenance'), (2, 'Repair'), (3, 'Installation'), (4, 'Expertise')], verbose_name='Job type')),
